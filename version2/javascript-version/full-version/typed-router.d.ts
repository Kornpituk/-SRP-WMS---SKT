...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-srp-setting': RouteRecordInfo<'apps-srp-setting', '/apps/srp/setting', Record<never, never>, Record<never, never>>,
    'apps-srp-stock-update': RouteRecordInfo<'apps-srp-stock-update', '/apps/srp/stockUpdate', Record<never, never>, Record<never, never>>,
    ...
    'org-srpdashboard': RouteRecordInfo<'org-srpdashboard', '/orgSRP/dashboard', Record<never, never>, Record<never, never>>,
    'org-srppacking-ptw': RouteRecordInfo<'org-srppacking-ptw', '/orgSRP/PackingPTW', Record<never, never>, Record<never, never>>,
    'org-srpreceiving': RouteRecordInfo<'org-srpreceiving', '/orgSRP/receiving', Record<never, never>, Record<never, never>>,
    'org-srprequest-for-picking': RouteRecordInfo<'org-srprequest-for-picking', '/orgSRP/requestForPicking', Record<never, never>, Record<never, never>>,
    'org-srpsetting': RouteRecordInfo<'org-srpsetting', '/orgSRP/setting', Record<never, never>, Record<never, never>>,
    'org-srpstock-update': RouteRecordInfo<'org-srpstock-update', '/orgSRP/stockUpdate', Record<never, never>, Record<never, never>>,
