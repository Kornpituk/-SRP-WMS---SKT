  ...
  themes: {
    light: {
      ...
      colors: {
        ...
        'deep-purple': '#673AB7', ///------------------------------------- deep-purple color ---------------------------
        ...
        'light-blue': '#03A9F4', ///------------------------------------- light-blue color ---------------------------
        ...
        'light-green': '#8BC34A', ///------------------------------------- light-green color ---------------------------
        ...
        'deep-orange': '#FF5722', ///------------------------------------- deep-orange color ---------------------------
        ...
        'blue-grey': '#607D8B', ///------------------------------------- blue-grey color ---------------------------
        ...
        'shades': '#9E9E9E', ///------------------------------------- shades color ---------------------------
        'shades-lighten-5': '#000000',
        'shades-lighten-4': '#FFFFFF',
        'shades-lighten-3': '#FFFFFF00',
        'green-barcode': '#C8E6C9',
        'violet-RFID': '#D1C4E9',
        'chip': '#F5F5F5',
      ...
      variables: {
        ...
        // 'shadow-key-umbra-color': '#00000000',
        // 'shadow-key-penumbra-color': '#00000000',
        // 'shadow-key-ambient-color': '#00000000',
      },
    },
    dark: {
      dark: true,
      colors: {
        ...
        'shades-lighten-4': '#FFFFFF',
        'shades-lighten-3': '#FFFFFF00',
        'green-barcode': '#1B5E20',
        'violet-RFID': '#311B92',
        'chip': '#4C4E64',
        'card-secondary': '#4c4e64',
      },
      variables: {
        'code-color': '#d400ff',
        'border-color': '#4c4e64',
