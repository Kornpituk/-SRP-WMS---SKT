...
//----------------------------- Dialog --------------------------------------------
const isDialogLotCreatedForProductsVisible = ref(false)
const isDialogCreatedTheLotAccordingToThePOVisible = ref(false)
...
//--------------------- check lot create by ------------------------------
const checkLotCreateBy = ref(false)

//------------------------ lot create by PO ----------------
const colorBtnCreateLotCode = ref('warning')
const variaintBtnCreateLotCode = ref('flat')

const isDialogCreateLotPOVisible = ref(false)
const isDialogLooksAtOldLotPOVisible = ref(false)

//-------------------------- lot create by Product -----------------
const colorBtnLooksAtOldLot = ref('grey')
const variaintBtnLooksAtOldLot = ref('outlined')

const isDialogCreateLotProductVisible = ref(false)
const isDialogLooksAtOldLotProductVisible = ref(false)

const checkSwitchLotCreateBy = () => {
...
<template>
  ...
  <!-- Dialog -->
  <section>
    <!-- Dialog Lot PO / Product -->
    <VDialog
      v-model="isDialogCreatedTheLotAccordingToThePOVisible"
      max-width="1400"
    >
      <!-- ----------------------- Create To PO ---------------------------- -->
      <!-- Dialog Content PO -->
      <VCard
        v-if="!checkLotCreateBy"
        class="pa-2"
      >
        <VCardTitle>
          <span><u>{{ $t('Created Lot') }}</u></span>
          <DialogCloseBtn
            variant="text"
            size="small"
            @click="isDialogCreatedTheLotAccordingToThePOVisible = false"
          />
        </VCardTitle>
          ...
          <VRow>
            ...
            >
              <VBtn
                ...
                variant="text"
                style="width: 100%;"
                @click="checkLotCreateBy = true"
              >
                {{ $t('According To Products') }}
              </VBtn>
            </VCol>
          </VRow>
        </VCardSubtitle>
        ...
        <VCardText
          ...
          class="pa-2 ma-2 bg-card-secondary"
        >
          <!-- Input -->
          <VCardText>
            <VCard>
              <VCardText>
                <!-- Purchase Order Number / Btn Clear - Add -->
                <VRow>
                ...
                <!-- LotProduct / Btn Create Stock Code / Stock History -->
                <VRow>
                  <!-- LotProduct  -->
                  <VCol
                    cols="12"
                  ...
                  <!--  Btn Create Stock Code / Stock History -->
                  <VCol
                    cols="12"
                    lg="4"
                  >
                    <VRow class="d-flex justify-start">
                      ...
                      >
                        <VBtn
                          ...
                          color="warning"
                          style="width: 100%;"
                          @click="isDialogCreateLotPOVisible = true"
                        >
                          {{ $t('Create Lot Code') }}
                        </VBtn>
                      </VCol>
                      ...
                      >
                        <VBtn
                          ...
                          color="grey"
                          style="width: 100%;"
                          @click="isDialogLooksAtOldLotPOVisible = true"
                        >
                          {{ $t('Look At Old Lot') }}
                        </VBtn>
                      </VCol>
                ...
                <!-- Production Date / Expiry / Expiry Date -->
                <VRow>
                  <!-- Production Date  -->
                  <VCol
                    cols="12"
      ...
      <!-- Dialog Content PO Old Lot -->
      <VDialog
        v-model="isDialogLooksAtOldLotPOVisible"
        width="auto"
      >
        <!-- Dialog Content -->
        <VCard>
          <VCardTitle>
            <u>{{ $t('List Of Lots Registered As Per PO') }}</u>
          </VCardTitle>
          <DialogCloseBtn
            variant="text"
            size="small"
            @click="isDialogLooksAtOldLotPOVisible = false"
          />
      ...
      <!-- Dialog Content PO Created -->
      <VDialog
        v-model="isDialogCreateLotPOVisible"
        width="auto"
      >
        <!-- Dialog Content -->
        <VCard>
          <DialogCloseBtn
            variant="text"
            size="small"
            @click="isDialogCreateLotPOVisible = false"
          />
            ...
            <VRow class="d-flex justify-center">
              ...
              <VCol cols="12">
                <span
                  ...
                  class="d-flex justify-center"
                >{{ $t('Successfully Created the Lot According to the PO') }}</span>
              </VCol>
            </VRow>
          </VCardText>
        </VCard>
      ...
      !-- Dialog Content Product Old Lot -->
      <VDialog
        v-model="isDialogLooksAtOldLotProductVisible"
        width="auto"
      >
        <!-- Dialog Content -->
        <VCard>
          ...
          <DialogCloseBtn
            variant="text"
            size="small"
            @click="isDialogLooksAtOldLotProductVisible = false"
          />
      ...
      <!-- Dialog Content Product Created -->
      <VDialog
        v-model="isDialogCreateLotProductVisible"
        width="auto"
      >
        <!-- Dialog Content -->
        <VCard>
          <DialogCloseBtn
            variant="text"
            size="small"
            @click="isDialogCreateLotProductVisible = false"
          />
          ...
          <VCardText>
            <VRow class="d-flex justify-center">
              ...
              <VCol cols="12">
                ...
                >{{ $t('Successfully Created the Lot According to the Product') }}</span>
              </VCol>
            </VRow>
          </VCardText>
        </VCard>
              ...
              <VCardText class="pa-2">
                <VRow class="d-flex align-center">
                  <VCol
                    ...
                    class="d-flex justify-lg-end"
                  >
                    <span class="text-h6">{{ $t('Status') }}:</span>
                  </VCol>
                  <VCol
                    cols="12"
                    lg="2"
        ...
        <VTable class="text-no-wrap table-header-bg rounded-0">
          ...
          <tbody>
            ...
            >
              ...
              <td
                class="text-start"
                style="overflow-wrap: break-word; white-space: pre-line;  word-wrap: break-word;"
              >
                {{ formattedProductName(product.productName) }}
              </td>
