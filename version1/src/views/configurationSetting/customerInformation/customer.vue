...
const customerCode = ['C001', 'C002', 'C003', 'C004', 'C005']
const customerName = ['John', 'Jane', 'Alice', 'Bob', 'Charlie']
const taxIdNumberMock = ['1234567890', '0987654321', '1111111111', '2222222222', '3333333333']
const addressMock = ['123 Main St', '456 Oak St', '789 Pine St', '321 Elm St', '654 Maple St']
const phoneNumberMock = ['123-456-7890', '987-654-3210', '555-555-5555', '111-111-1111', '222-222-2222']
const fexMock = ['FEX-123', 'FEX-456', 'FEX-789', 'FEX-321', 'FEX-654']
const emailMock = ['y0dUd@example.com', 'a0Q0h@example.com', 'b0Q0h@example.com', 'c0Q0h@example.com', 'd0Q0h@example.com']
const idLineMock = ['@john', '@jane', '@alice', '@bob', '@charlie']
const lastupdateMock = ['2022-01-01', '2022-02-01', '2022-03-01', '2022-04-01', '2022-05-01']

// สร้างข้อมูลแบบสุ่ม
for (let i = 0; i < customerCode.length; i++) {
  const dataMock = {
    customerCode: customerCode[i % customerCode.length],
    customerName: customerName[i % customerName.length],
    taxIdNumberMock: taxIdNumberMock[i % taxIdNumberMock.length],
    addressMock: addressMock[i % addressMock.length], 
    phoneNumberMock: phoneNumberMock[i % phoneNumberMock.length],
    fexMock: fexMock[i % fexMock.length],
    emailMock: emailMock[i % emailMock.length],
    idLineMock: idLineMock[i % idLineMock.length],
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Add Customer Data') }}</span>
            </VCardTitle>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5">{{ $t('Customer Data Has Been Added') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Edit Customer Data') }}</span>
            </VCardTitle>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5">{{ $t('Customer Data Has Been Edited') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Remove Customer Data') }}</span>
            </VCardTitle>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5">{{ $t('Customer Data Has Been Deleted') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
