...
const searchByDivisionName = ref('')
...
const toggleSortType = sortBy => {
  try {
    const sortRefs = { sortByDivisionId, sortByLastUpdate }
...
const getDivision = () => {
  ...
  axiosIns.get(`${urlApi.value}/api/v1/EmpDivision?page=`+currentPage.value+`&perPage=`+rowPerPage.value, {
    headers: {
      'accept': '*/*',
    ...
    params: {
      ...
      searchByDivisionName: searchByDivisionName.value,

      sortByDivisionId: sortByDivisionId.value,
...
const postDivisionId = ref('')
const postDivisionName = ref('')
...
const postDivision = () => {
  ...
  const Data = {
    divisionId: postDivisionId.value,
    divisionName: postDivisionName.value,
  }

  axiosIns.post(`${urlApi.value}/api/v1/EmpDivision/Add`, Data, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
...
const startEdit = (id, name) => {
  ...
  editDivisionName.value = name
}

const editDivision = () => {

  const Data = {
    divisionId: editDivisionId.value,
    divisionName: editDivisionName.value,
  }

  axiosIns.post(`${urlApi.value}/api/v1/EmpDivision/Edit`, Data, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
...
const deleteDivisionId = ref('')

const deleteDivisionName = ref('')

const startDelete = (id, name) => {
  isDialogVisibleBtnDelete.value = true
  deleteDivisionId.value = id
  deleteDivisionName.value = name
}

const deleteDivision = () => {
  const Data = ''

  axiosIns.post(`${urlApi.value}/api/v1/EmpDivision/Delete/${deleteDivisionId.value}`, Data, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Add Division') }}</span>
            </VCardTitle>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Edit Division') }}</span>
            </VCardTitle>
            <VCardText>
              <VRow>
                <!-- Division Code -->
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Remove Division') }}</span>
            </VCardTitle>
  ...
  <section>
    <VCard class="mt-6">
      ...
      <VTable class="text-no-wrap table-header-bg rounded-0">
          ...
          <tr>
            ...
            >
              ...
              <VIcon
                ...
                @click="toggleSortType('sortByDivisionId')"
              />
            </th>
            <th
              scope="row"
        ...
        <tbody>
          <tr
            v-for="(product, index) in Division"
            :key="index"
          >
            <!-- 👉 Ordinal Number -->
            ...
            >
              <VIcon
                ...
                @click="startEdit(product.divisionId,product.divisionName)"
              />
              <VIcon
                color="error"
                icon="mdi-trash-can-outline"
                @click="startDelete(product.divisionId,product.divisionName)"
              />
            </td>
          </tr>
        </tbody>
