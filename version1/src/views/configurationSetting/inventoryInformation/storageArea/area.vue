...
//----------------------  SortBy Variable  -------------------------------------
const sortByAreaId = ref('')
const sortByLastUpdate = ref('')


const toggleSortType = sortBy => {
  try {
    const sortRefs = { sortByAreaId, sortByLastUpdate }
...
const getArea = () => {
  ...
  axiosIns.get(`${urlApi.value}/api/v1/InventoryArea?page=`+currentPage.value+`&perPage=`+rowPerPage.value, {
    headers: {
      'accept': '*/*',
    ...
    params: {
      ...
      searchByAreaName: searchByAreaName.value,

      sortByAreaId: sortByAreaId.value,
...
const postAreaId = ref('')
const postAreaName = ref('')
...
const postArea = () => {
  ...
  const postData = {
    areaId: postAreaId.value,
    areaName: postAreaName.value,
  }

  axiosIns.post(`${urlApi.value}/api/v1/InventoryArea/Add`, postData, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
...
const startEdit = (AreaId, AreaName) => {
  isDialogVisibleBtnEdit.value = true
  editAreaId.value = AreaId
  editAreaName.value = AreaName
}

const editArea = () => {

  const postData = {
    areaId: editAreaId.value,
    areaName: editAreaName.value,
  }

  axiosIns.post(`${urlApi.value}/api/v1/InventoryArea/Edit`, postData, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
...
const startDelete = (AreaId, AreaName) => {
...
const deleteArea = () => {
  ...
  axiosIns.post(`${urlApi.value}/api/v1/InventoryArea/Delete/${deleteAreaId.value}`, postData, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Add Storage Area') }}</span>
            </VCardTitle>
              ...
              <VRow>
                ...
                >
                  <VRow class="mx-4">
                    ...
                    >
                      <VTextField
                        v-model="postAreaName"
                        :label="$t('Storage Area Name')"
                        density="compact"
                      />
                    </VCol>
                  </VRow>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5 text-center px-6">{{ $t('Storage Area Has Been Added') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Edit Storage Area') }}</span>
            </VCardTitle>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5">{{ $t('Storage Area Has Been Edited') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Remove Storage Area') }}</span>
            </VCardTitle>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5">{{ $t('Storage Area Has Been Removed') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
          ...
          <tr>
            ...
            >
              ...
              <VIcon
                ...
                @click="toggleSortType('sortByAreaId')"
              />
            </th>
            <th
              scope="row"
          ...
          >
            ...
            >
              <VIcon
                ...
                @click="startEdit(product.areaId,product.areaName)"
              />
              <VIcon
                color="error"
                icon="mdi-trash-can-outline"
                @click="startDelete(product.areaId,product.areaName)"
              />
            </td>
          </tr>
        </tbody>
