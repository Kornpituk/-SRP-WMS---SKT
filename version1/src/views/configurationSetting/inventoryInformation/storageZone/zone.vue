...
const getZoneConfig = () => {
  ...
  axiosIns.get(`${urlApi.value}/api/v1/InventoryZone?page=`+currentPage.value+`&perPage=`+rowPerPage.value, {
    headers: {
      'accept': '*/*',
    ...
    params: {
      ...
      searchByZoneName: searchByZoneName.value,

      sortByZoneId: sortByZoneId.value,
      sortByLastUpdate: sortByLastUpdate.value,
    },
  }, {})
    .then(response => {

      zone.value = response.data.items
      totalCount.value = response.data.totalCount
      currentPage.value = response.data.page
      totalPage.value = response.data.totalPages
      rowPerPage.value = response.data.perPage

      console.log('[products.value]!!: ', zone.value)
    })
    .catch(error => {
    // Handle errors
...
const paginationData = computed(() => {
  const firstIndex = zone.value.length ? (currentPage.value - 1) * rowPerPage.value + 1 : 0
  const lastIndex = zone.value.length + (currentPage.value - 1) * rowPerPage.value
...
const postZoneId = ref('')
const postZoneName = ref('')
...
const postSubZone = () => {
  ...
  const postData = {
    ZoneId: postZoneId.value,
    ZoneName: postZoneName.value,
  }

  axiosIns.post(`${urlApi.value}/api/v1/InventoryZone/Add`, postData, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
...
const startEdit = (ZoneId, ZoneName) => {
  isDialogVisibleBtnEdit.value = true
  editZoneId.value = ZoneId
  editZoneName.value = ZoneName
}
...
const editZone = () => {
  ...
  const postData = {
    ...
    zoneName: editZoneName.value,
  }

  axiosIns.post(`${urlApi.value}/api/v1/InventoryZone/Edit`, postData, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
...
const startDelete = (ZoneId, ZoneName) => {
...
const deleteSubZone = () => {
  ...
  // console.log('searchByCategoryName: ',searchByCategoryName)
  axiosIns.post(`${urlApi.value}/api/v1/InventoryZone/Delete/${deleteZoneId.value}`, postData, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Add Storage Zone') }}</span>
            </VCardTitle>
              ...
              <VRow>
                ...
                >
                  <VRow class="mx-4">
                    ...
                    >
                      <VTextField
                        v-model="postZoneName"
                        :label="$t('Storage Zone Name')"
                        density="compact"
                      />
                    </VCol>
                  </VRow>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5 text-center px-6">{{ $t('Storage Zone Has Been Added') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Edit Storage Zone') }}</span>
            </VCardTitle>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5">{{ $t('Storage Zone Has Been Edited') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Remove Storage Zone') }}</span>
            </VCardTitle>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5">{{ $t('Storage Zone Has Been Removed') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
          ...
          <tr>
            ...
            >
              ...
              <VIcon
                ...
                @click="toggleSortType('sortByZoneId')"
              />
            </th>
            <th
              scope="row"
          ...
          >
            ...
            >
              <VIcon
                ...
                @click="startEdit(product.zoneId,product.zoneName)"
              />
              <VIcon
                color="error"
                icon="mdi-trash-can-outline"
                @click="startDelete(product.zoneId,product.zoneName)"
              />
            </td>
          </tr>
        </tbody>
