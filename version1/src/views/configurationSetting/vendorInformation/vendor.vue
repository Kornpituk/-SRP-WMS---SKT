...
const vendorCode = ['V001', 'V002', 'V003', 'V004', 'V005']
const vendorName = ['John', 'Jane', 'Alice', 'Bob', 'Charlie']
...
for (let i = 0; i < vendorCode.length; i++) {
  const role = {
    vendorCode: vendorCode[i % vendorCode.length],
    vendorName: vendorName[i % vendorName.length],
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardTitle>
              <span style="text-decoration: underline;">{{ $t('Add Vendor Data') }}</span>
            </VCardTitle>
      ...
      <div>
        ...
        >
          ...
          <VCard>
            ...
            <VCardText class="d-flex justify-center">
              <span class="text-h5">{{ $t('Vendor Data Has Been Added') }}</span>
            </VCardText>
          </VCard>
        </VDialog>
      </div>
