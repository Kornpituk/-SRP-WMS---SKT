...
const receiveDateData = ref(null) // Date ---
const pickingGoodsNoData = ref(null)
const requestNoData = ref(null)
const requestDateData = ref(null) // Date ---
const deliveryDateData = ref(null) // Date ---
const pickingWarehouseData = ref(null)
const customerNameData = ref(null)
const remarkRequestData = ref(null)
const remarkTranferInData = ref(null)
const reasonRequestData = ref(null)
const reasonTranferInData = ref(null)
const receiveByData = ref(null)

const pickingGoodsDateData = ref(null) // Date ---

const menuReceiveNo = ref( false)
const menuReceiveDate = ref(false) // Date --- 
const menuPickingGoodsNo = ref(false)
const menuRequestNo = ref(false)
const menuRequestDate = ref(false) // Date ---
const menuDeliveryDate = ref(false) // Date ---
...
const sortByColRerceiveDateData = ref('')
const sortByColPickingDateData = ref('')
const sortByColRequestDateData = ref('')
const sortByColReceiveQtyData = ref('')
...
const GetReceivedPoHeader = () => {
  ...
  axiosIns.get(`${urlApi.value}/api/v1/Dashboard/Performance/TranferIn/Header?page=`+currentPage.value+`&perPage=`+rowPerPage.value, {
    headers: {
      'accept': '*/*',
    ...
    // dateSp: dateSpData.value,
      ...
      pickingGoodsDate: pickingGoodsDateData.value,

      sortByColReceiveDate: sortByColRerceiveDateData.value,
      sortByColPickingDate: sortByColPickingDateData.value,
      sortByColRequestDate: sortByColRequestDateData.value,
      sortByColDeliveryDate: sortByColReceiveQtyData.value,
          ...
          <tr>
            ...
            >
              ...
              <VIcon
                ...
                @click="sortByColRerceiveDateData = sortByColRerceiveDateData === 'asc' ? 'desc' : 'asc'"
              />
            </th>
            <th
              scope="row"
            ...
            <th
              ...
              class="text-start px-1"
            >
              {{ $t('Reason Transfer In') }}
              <!-- ----------------------------- Menu Search By --------------------- -->
              <VMenu
                v-model="menuReasonTranferIn"
                :close-on-content-click="false"
                location="end"
              >
                <template #activator="{ props }">
                  ...
                  <VList>
                    <VListItem>
                      <VRow>
                        ...
                        >
                          <VTextField
                            v-model="reasonTranferInData"
                            class="mt-4"
                            :label="$t('Reason Transfer In')"
                          />
                        </VCol>
                        ...
                        >
                          <VBtn
                            type="submit"
                            style="width: 100%;"
                            @click="menuReasonTranferIn = false"
                          >
                            {{ $t('Cancel') }}
                          </VBtn>
                        </VCol>
            ...
            >
              ...
              <VIcon
                color="primary"
                icon="mdi-pan-vertical"
                @click="sortByColPickingDateData = sortByColPickingDateData === 'asc' ? 'desc' : 'asc'"
              />
            </th>
            <th
              scope="row"
                  ...
                  <VList>
                    <VListItem>
                      <VRow>
                        ...
                        >
                          <VTextField
                            v-model="pickingWarehouseData"
                            class="mt-4"
                            :label="$t('Picking Warehouse')"
                          />
                        </VCol>
                        ...
                        >
                          <VBtn
                            type="submit"
                            style="width: 100%;"
                            @click="menuPickingWarehouse = false"
                          >
                            {{ $t('Cancel') }}
                          </VBtn>
                        </VCol>
            ...
            >
              ...
              <VIcon
                color="primary"
                icon="mdi-pan-vertical"
                @click="sortByColRequestDateData = sortByColRequestDateData === 'asc' ? 'desc' : 'asc'"
              />
            </th>
            <th
              v-if="checkConfigUser(nameUser)"
                      ...
                      <VRow>
                        ...
                        >
                          <VBtn
                            type="submit"
                            style="width: 100%;"
                            @click="menuRemarkTranferIn = false"
                          >
                            {{ $t('Cancel') }}
                          </VBtn>
                        </VCol>
