...
const setHistoryBlock = () => {
  
}

//------------------------------------ Tabs Details/Header -------------------------------------------
import Header from '../transferIn/header.vue'
import Details from '../transferIn/datails.vue'
...
<template>
  <div>
    <VCard
      height="40px"
      class="d-flex align-center bg-deep-orange-lighten-1"
    >
