...
const sortByColQty = ref(null)
const sortByColLocation = ref(null)
...
const menuIsuueNo = ref(false)
const menuIsuueBy = ref(false)

const menuRemark = ref(null)
const menuReason = ref(null)
const menuRefDoc = ref(null)
