...
export const getDonutChartConfigPO = themeColors => {
  ...
  return {
    ...
    stroke: { width: 0 },
    labels: ['WAITING FOT RECEIVE', 'RECEIVEDdd'],
...
export const getDonutChartConfigPOSuccessMove = themeColors => {
  const donutColors = {
    series2: '#2196F3',
    series3: '#FFC400',
    series4: '#E91E63',
...
export const getDonutChartConfigPOSuccessNonMove = themeColors => {
  const donutColors = {
    series2: '#2196F3',
    series3: '#FFC400',
    series4: '#E91E63',
