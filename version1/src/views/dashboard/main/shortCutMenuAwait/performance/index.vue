...
const showDialogImage = (urlImageProduct, nameImageProduct) => {
  urlImage.value = urlImageProduct
  nameImage.value = nameImageProduct
  ...
  <section>
    ...
    >
      ...
      >
        ...
        <VCardTitle>
          {{ $t('Product Name') }} :  {{ (nameImage) }}
        </VCardTitle>

       
        <VCardActions style="width: 100%; padding: 0;">
          <VBtn
            color="red-lighten-1"
            variant="text"
            style="width: 100%;"
              ...
              <div v-if="false">
                ...
                >
                  <VImg
                    ...
                    cover
                    :src="product.image"
                    @click="showDialogImage(product.image,product.categoryName)"
                  />
                </VBtn>
              </div>
              <div v-if="true">
