...
//------------------------------------ Tabs Details/Header -------------------------------------------
import Header from '../transferOut/header.vue'
import Details from '../transferOut/datails.vue'
...
<template>
  ...
  <div>
    <VCard
      height="40px"
      class="d-flex align-center bg-blue-lighten-1"
    >
        ...
        >
          <template #item="{ item }">
            <tr>
              ...
              <td :class="resolveChipColorTable(item.raw.status)">
                <span>{{ item.raw.pickingBy }}</span>
              </td>
              <td :class="resolveChipColorTable(item.raw.status)">
                {{ item.raw.approveCancelBy }}
              </td>
              <td :class="resolveChipColorTable(item.raw.status)">
                <span>{{ item.raw.approveCancelDate }}</span>
              </td>
              <td :class="resolveChipColorTable(item.raw.status)">
                {{ item.raw.remark }}
              </td>
