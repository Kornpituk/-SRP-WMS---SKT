...
import { useTermOfPricingActions } from './composables/useTermOfPricingActions'
import { useTermOfPricingData } from './composables/useTermOfPricingData'

const search = reactive({
  keyword: '',
})

const { rows, loading, error, loadRows } = useTermOfPricingData()
...
const {
  ...
  closeDeleteDialog,
  removeItem,
} = useTermOfPricingActions(applySearch, setError)
...
<template>
  <VContainer fluid>
    ...
    >
      <VCard>
        <VCardTitle>{{ form.id ? 'Edit' : 'Create' }} Term of Pricing</VCardTitle>
        <VCardText>
          <VRow>
            <VCol
              cols="12"
    ...
    >
      <VCard>
        <VCardTitle>Delete Term of Pricing</VCardTitle>
