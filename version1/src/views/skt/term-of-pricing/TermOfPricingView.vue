...
const pageTitle = 'Term of Pricing'
const { items, loading, error, loadItems } = useTermOfPricingData()
const { submitting, saveItem, removeItem } = useTermOfPricingActions()
...
const headers = [
  { title: 'Code', key: 'code' },
  { title: 'Term of Pricing', key: 'name' },
