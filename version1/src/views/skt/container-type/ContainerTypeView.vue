...
const pageTitle = 'Container Type'
const { items, loading, error, loadItems } = useContainerTypeData()
const { submitting, saveItem, removeItem } = useContainerTypeActions()
