...
import { useContainerTypeActions } from './composables/useContainerTypeActions'
import { useContainerTypeData } from './composables/useContainerTypeData'

const search = reactive({
  keyword: '',
})

const { rows, loading, error, loadRows } = useContainerTypeData()
...
const {
  ...
  closeDeleteDialog,
  removeItem,
} = useContainerTypeActions(applySearch, setError)
...
<template>
  <VContainer fluid>
    ...
    >
      <VCard>
        <VCardTitle>{{ form.id ? 'Edit' : 'Create' }} Container Type</VCardTitle>
        <VCardText>
          <VRow>
            <VCol
              cols="12"
    ...
    >
      <VCard>
        <VCardTitle>Delete Container Type</VCardTitle>
