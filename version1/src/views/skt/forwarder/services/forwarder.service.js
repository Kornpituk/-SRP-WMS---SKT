...
const API_PATH = '/api/v1/setting-master/forwarder'

export const fetchForwarderListService = async params => {
...
export const createForwarderService = async payload => {
...
export const updateForwarderService = async (id, payload) => {
...
export const deleteForwarderService = async id => {
