...
const pageTitle = 'Sale Person'
const { items, loading, error, loadItems } = useSalePersonData()
const { submitting, saveItem, removeItem } = useSalePersonActions()
