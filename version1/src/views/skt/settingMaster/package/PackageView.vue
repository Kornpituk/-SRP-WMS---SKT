...
const { rows, loading, error, loadRows } = usePackageData()
...
const {
  ...
  closeDeleteDialog,
  removeItem,
} = usePackageActions(applySearch, setError)
...
<template>
  <VContainer fluid>
    ...
    >
      <VCard>
        <VCardTitle>{{ form.id ? 'Edit' : 'Create' }} Package</VCardTitle>
        <VCardText>
          <VRow>
            <VCol
              cols="12"
    ...
    >
      <VCard>
        <VCardTitle>Delete Package</VCardTitle>
