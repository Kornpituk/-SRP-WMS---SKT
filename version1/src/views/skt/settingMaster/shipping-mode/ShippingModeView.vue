...
const pageTitle = 'Shipping Mode'
const { items, loading, error, loadItems } = useShippingModeData()
const { submitting, saveItem, removeItem } = useShippingModeActions()
