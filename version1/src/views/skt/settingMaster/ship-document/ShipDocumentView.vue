...
import { useShipDocumentActions } from './composables/useShipDocumentActions'
import { useShipDocumentData } from './composables/useShipDocumentData'

const pageTitle = 'Ship Document'
const { items, loading, error, loadItems } = useShipDocumentData()
const { submitting, saveItem, removeItem } = useShipDocumentActions()
