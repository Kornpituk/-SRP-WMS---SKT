...
const { rows, loading, error, loadRows } = useTermOfPaymentData()
...
const {
  ...
  closeDeleteDialog,
  removeItem,
} = useTermOfPaymentActions(applySearch, setError)
...
<template>
  <VContainer fluid>
    ...
    >
      <VCard>
        <VCardTitle>{{ form.id ? 'Edit' : 'Create' }} Term of Payment</VCardTitle>
        <VCardText>
          <VRow>
            <VCol
              cols="12"
    ...
    >
      <VCard>
        <VCardTitle>Delete Term of Payment</VCardTitle>
