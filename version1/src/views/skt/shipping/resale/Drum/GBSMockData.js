export const GBSmockDataIm = ref({
...
export const specialRequestsIm = ref([
  {
    conditions: [
...
export const shippingMarkIm = ref([
  { language: 'Thai' },
  { language: 'English' },
  { language: 'Japanese' },
  { language: 'Chinese' },
...
export const validateAfterPickingIm = ref([
...
export const resaleProductShippingIm = ref([  
