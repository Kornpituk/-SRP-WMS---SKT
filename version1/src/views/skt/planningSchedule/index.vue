...
<template>
  ...
  <div class="mt-4">
    ...
    <VBtn color="warning" class="mx-4" @click="isDialogAddVisible = true">
      Add Plan
    </VBtn>
    <VBtn
      color="red"
      @click="cancelAllProducts"
    >
      Cancel
    </VBtn>
  </div>
