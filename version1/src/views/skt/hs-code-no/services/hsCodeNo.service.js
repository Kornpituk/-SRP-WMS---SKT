...
const makeMockRow = (index, label) => ({
  id: index,
  code: 'HSC' + String(index).padStart(3, '0'),
  name: label,
  description: 'HS Code master record ' + index,
...
let mockRows = [
  makeMockRow(1, 'Organic surface-active agents'),
  makeMockRow(2, 'Industrial alcohol preparations'),
  makeMockRow(3, 'Synthetic resin compounds'),
  makeMockRow(4, 'Water treatment chemicals'),
  makeMockRow(5, 'Agricultural nutrient solution'),
  makeMockRow(6, 'Textile processing auxiliary'),
  makeMockRow(7, 'Automotive cleaning chemicals'),
  makeMockRow(8, 'Protective coating additives'),
  makeMockRow(9, 'Electronic grade solvent'),
  makeMockRow(10, 'Food contact packaging material'),
  makeMockRow(11, 'Adhesive base compounds'),
  makeMockRow(12, 'Colorant dispersion mixture'),
  makeMockRow(13, 'Rubber processing aid'),
  makeMockRow(14, 'Lubricant performance additive'),
  makeMockRow(15, 'Corrosion inhibitor formula'),
  makeMockRow(16, 'Pharmaceutical excipient blend'),
  makeMockRow(17, 'Silicone emulsion product'),
  makeMockRow(18, 'Defoamer industrial use'),
  makeMockRow(19, 'Biocide controlled concentration'),
  makeMockRow(20, 'General purpose solvent blend'),
]
...
const basePath = `${urlApi.value}/api/v1/SettingMaster/hs-code-no`
