...
import {
  ...
  save,
} from '@/services/skt/inv/lorryLoading/dieselService'
import { useItemStore } from '@/stores/skt/receingFormStore/itemStore'
import image01 from '@/views/skt/receiving/lorryForm/c3/Diesel.png'
...
async function approve(e) {
  ...
  var response = await axios.post(`${urlApi.value}/api/v1/LorryFormDiesel/approve/${poEtlLogDetailJournalIDQueryParameters.value}`, null, {
    headers: {
      'accept': '*/*',
      'x-location': `${whereHouse}`,
      Authorization: `Bearer ${accessTokenAtStore}`,
      ...
      <table class="custom-table">
        ...
        <tbody>
          ...
          >
            ...
            <td
              colspan="4"
              style="min-width: 200px; border-left: 1px solid black;"
            >
