...
const headers = [
  ...
  },
  {
    title: 'Item Code',
    key: 'itemCode',
    permission: 'COL_MATERIAL_CODE',
  },
  {
    title: 'Item Name',
    key: 'itemName',
    permission: 'COL_MATERIAL_NAME',
  },
  {
    title: 'Trade Name',
    key: 'concatTradename',
    permission: 'COL_TRADE_NAME',
  },
  {
    title: 'Supplier Code',
    key: 'supplierId',
    permission: 'COL_SUPPLIER',
    
  },
  {
    title: 'Supplier Name',
    key: 'supplierName',
    permission: 'COL_SUPPLIER_NAME',
  },
  {
    title: 'P/O No.',
    key: 'purchaseOrderNo',
    permission: 'COL_PURCHASE_ORDER_NO',
  },
  {
    title: 'Delivery Date',
    key: 'deliveryDate',
    permission: 'COL_DELIVERY_DATE',
  },
  {
    title: 'Lot',
    key: 'batch',
    permission: 'COL_BATCH',
  },
  { 
    title: 'PURC(Pcs)', 
    align: 'end', key: 'purchasingQuantityPcs', 
    permission: 'COL_PURCHASING_AMOUNT' },
  { 
    title: 'PURC(Kgs)', 
    align: 'end', 
    key: 'purchasingAmountKgs',
    permission: 'COL_PURCHASING_QUANTITY' },
  { 
    title: 'RCVD(Pcs)', 
    align: 'end', 
    key: 'purchasingQuantityRcvdPcs',
    permission: 'COL_PURCHASING_AMOUNT' },
  { 
    title: 'RCVD(Kgs)', 
    align: 'end', 
    key: 'purchasingAmountRcvdKgs',
    permission: 'COL_PURCHASING_QUANTITY' },
  {
    title: 'Updated By',
    key: 'updatedBy',
...
<style scoped src="./receivingPlan.scss"></style>
