...
<template>
  ...
  <div
    v-if="readonly"
    class="party-block text-body-2"
  >
    <div class="font-weight-medium">
      {{ party.name }}
    </div>
    <div v-if="party.address">
      {{ party.address }}
    </div>
