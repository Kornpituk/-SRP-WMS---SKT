...
const resaleProductShipping = ref([
  { sKTLotNo: 'PC2311000B', supplierLotNo: '4500178132/0320',  productCode: 'CHEMICAL PR-029',  tradeName: 'CHEMICAL PR-029',  packaging: 'DM',  netContent: '200',   amount: '8',   quantity: '1,800.00',  customerName: 'INNOVATIVE CHEMICALS', deliveryPlace: 'SKT', appearanceCheck: true, remark: '12 Bags X 1 พาเลท' },
  { sKTLotNo: 'PC2311001C', supplierLotNo: '4500178133/0321',  productCode: 'CHEMICAL PR-030',  tradeName: 'CHEMICAL PR-030',  packaging: 'DM',  netContent: '300',   amount: '10',   quantity: '2,000.00',  customerName: 'ADVANCED CHEMICALS', deliveryPlace: 'SKT', appearanceCheck: false, remark: '10 Bags X 1 พาเลท' },
    ...
    <div class="my-6">
      ...
      >
        ...
        <tr>
          <td>1</td>
          <td>PC2311000B</td>
          <td>4500178132/0320</td>
          <td>CHEMICAL PR-029</td>
          <td>CHEMICAL PR-029</td>
          <td>DM</td>
          <td>200</td>
          <td>8</td>
          <td>1,800.00</td>
          <td>INNOVATIVE CHEMICALS</td>
          <td
            colspan="2"
            class="text-center"
          >
        ...
        <!-- Example for adding more rows -->
        <tr>
          <td>2</td>
          <td>PC2311001C</td>
          <td>4500178133/0321</td>
          <td>CHEMICAL PR-030</td>
          <td>CHEMICAL PR-030</td>
          <td>DM</td>
          <td>300</td>
          <td>10</td>
          <td>2,000.00</td>
          <td>ADVANCED CHEMICALS</td>
          <td
            colspan="2"
            class="text-center"
          >
        ...
        <tr>
          <td
            colspan="3"
            class="section-title text-center bg-perfect-scrollbar-thumb"
          >
          ...
          <td
            colspan="5"
            class="section-title text-center bg-yellow"
          >
            Picture Label
          </td>
          <td
        ...
        <tr>
          ...
          <td
            ...
            :style="{
              ...
              borderWidth: selectedLanguage.includes('Thai') ? '5px': '1px',
              borderStyle: 'solid',
            }"
          ...
          <td
            ...
            rowspan="1"
          >
            ฉลากภาษาอังกฤษ / ฉลากภาษาญี่ปุ่น
          </td>
          <td
            colspan="5"
            rowspan="6"
        ...
        <tr>
          ...
          <td
            ...
            :style="{
              ...
              borderWidth: selectedLanguage.includes('English') ? '5px': '1px',
              borderStyle: 'solid',
        ...
        <tr>
          ...
          <td
            ...
            :style="{
              ...
              borderWidth: selectedLanguage.includes('Japanese') ? '5px': '1px',
              borderStyle: 'solid',
            }"
        ...
        <tr>
          ...
          <td
            ...
            :style="{
              ...
              borderWidth: selectedLanguage.includes('Chinese') ? '5px': '1px',
              borderStyle: 'solid',
            }"
        ...
        <tr>
          ...
          <td colspan="2">
            ส่ง ตัวอย่าง 250 g = 1 ขวด/Lot ให้ SCI พร้อมแนบไปกับสินค้า
          </td>
          <td
            class="text-center"
            colspan="2"
          ...
          <td
            ...
            :style="{
              ...
              borderWidth: selectedLanguage.includes('Malaysia') ? '5px': '1px',
              borderStyle: 'solid',
            }"
        ...
        <tr>
          ...
          <td colspan="2">
            ตืดฉลากภาษาญี่ปุ่นและภาษาอังกฤษ
          </td>
          <td
            class="text-center"
            colspan="2"
          ...
          <td
            ...
            :style="{
              ...
              borderWidth: selectedLanguage.includes('SDS') ? '5px': '1px',
              borderStyle: 'solid',
            }"
        ...
        <tr>
          ...
          <td colspan="4">
            ฉลากมีทั้ง2ภาษาและติดคู่กันถูกต้อง
          </td>
        </tr>
        ...
        <tr>
          <td colspan="5">
            หมายเหตุ : คนขับรถ ตรวจสภาพสินค้าหลังนำขึ้นรถแล้ว  สภาพปกติ ไม่รั่ว 
          </td>
          <td
            colspan="5"
            class=""
      ...
      <VRow>
        ...
        >
          ...
          <table class="custom-table">
            ...
            <tr
              v-for="(item ,index) in expoertAndDomain"
              :key="index"
            >
              <td colspan="4">
                {{ item.deliveryPlace }}
