...
//--------------------------- theme ----------------------
import urlImageDark from '@images/icons/themeDark.png'
import urlImageLightH from '@images/icons/themeLightH.png'
import urlImageLight from '@images/icons/themeLight.png'

const themeWeb = ref(null)

//----------------------------- Switch Theme --------------------
const selectedRadio = ref(localStorage.getItem('srp-theme-config'))

const colorsRadio = [
  { title: 'Primary', value: 'primary' },
  { title: 'Warehouse Harmony', value: 'warehouse-harmony' },
  { title: 'Inventory Insight', value: 'inventory-insight' },
  { title: 'Logistics Luxe', value: 'logistics-luxe' },
  { title: 'Operation Optimizer', value: 'operation-optimizer' },
]

const switchTheme = value => {
  console.log('Switch theme = ' + value)
  localStorage.setItem('srp-theme-config', value)
  location.reload()
}

// watchEffect(() => {
//   switchTheme(selectedRadio.value)
//   console.log('srp-theme-config', localStorage.getItem('srp-theme-config'))
// })
</script>
        ...
        >
          ...
          <VRow>
            <VCol cols="4">
              ...
              >
                <template #badge>
                  <VIcon icon="mdi-check-bold" /><span>&nbsp;&nbsp;{{ $t('System') }}</span>
                </template>
              ...
              <VIcon
                v-if="theme === 'dark' || theme === 'light'"
                class="mb-2"
                size="100"
                @click="theme = 'system'"
              >
                <VImg :src="urlImageLightH" />
              </VIcon>
            </VCol>
            ...
            <VCol cols="4">
              ...
              >
                <template #badge>
                  <VIcon icon="mdi-check-bold" /><span>&nbsp;&nbsp;{{ $t('Light') }}</span>
                </template>

                <VIcon size="100">
                  <VImg :src="urlImageLight" />
                </VIcon>
              </VBadge>
              <VIcon
            ...
            <VCol cols="4">
              ...
              >
                <template #badge>
                  <VIcon icon="mdi-check-bold" /><span>&nbsp;&nbsp;{{ $t('Dark') }}</span>
                </template>
                <VIcon size="100">
                  <VImg :src="urlImageDark" />
                </VIcon>
              </VBadge>
              <VIcon
