...
export const getRadialBarChartConfig = themeColors => {
  ...
  return {
    ...
    labels: ['Waiting for approval', 'Approved/waiting for arrangement', 'Completely arranged'],
    legend: {
      show: true,
      position: 'bottom',
      labels: {
...
export const getDonutChartConfigProduct = themeColors => {
  const donutColors = {
    series1: '#fdd835',
    series2: '#00d4bd',
    series3: '#826bf8',
  ...
  return {
    stroke: { width: 0 },
    labels: ['LADIES WEAR', 'LADIES DENIM', 'SHOES78', 'PANT'],
    colors: [donutColors.series1, donutColors.series5, donutColors.series3, donutColors.series2],
    dataLabels: {
      enabled: true,
      formatter: val => `${parseInt(val, 10)}%`,
